...
###########################
def add2list(date, remark):
###########################
    alldates.append(date + " " + remark)
    ...
    for line in f:
        ...
        if not re.match("#", line):
            ...
            if re.match("^[-0-9]+$", time): # Datum abhaengig von Ostern
                ...
                add2list(to_date(time), description)
                ...
                while dat1 <= dat2:
                    add2list(to_date(dat1),description)
                    dat1 = dat1 + day
                ...
                if timelist[2] == '':
                    timelist[2] = ryear
                add2list("%s.%s.%s" % (timelist[0], timelist[1], timelist[2]), description)
    f.close()
